...
# from network import resnet,HRnet,PB_resnet,PB_net,SK_PB_resnet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--COEFF_1', default=12.0, type=float)
    parser.add_argument('--COEFF_2', default=12.0, type=float)
    parser.add_argument('--COEFF_3', default=12.0, type=float)
    ...
    #
    #
    # val_dataloader = DataLoader(val_dataset,batch_size=args.batch_size,shuffle=False,num_workers=4,pin_memory=False,drop_last=True)
    #
    ...
    loglist = do_python_eval(f'/root/zh/Adpnet/affnet_res50/rw_dir_5/', args, 0)
    ...
    #                    f'/users4/mxtuo/zhanghan/DBnet/{args.session_name}/model_weights/res50-bs={args.batch_size}-cf={args.COEFF}-mIoU={mIoU:.5}.pth')
    #
    #
